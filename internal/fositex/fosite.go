...
// This is slighly modified from `compose.Compose`, here we accept a
...
func NewOAuth2Provider(cfg OAuth2Configurator, store interface{}, strategy interface{}, factories ...compose.Factory) fosite.OAuth2Provider {

	config := cfg.GetFositeConfig()
	storage := store
